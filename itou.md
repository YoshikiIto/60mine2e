...
[テスト自動化研究会 - テスト自動化の8原則](https://sites.google.com/site/testautomationresearch/test_automation_principle)　より
...
**Point：「E2Eテストの自動化」に閉じずに、開発・テストをどうしたいかを考えよう**
...
# E2Eテストの自動化対象範囲を選ぶ考え方
- どこをテストするか
  - ユーザーが使う各機能について、基本的な正常系ユーザーシナリオをテストする
- どこまでテストするか
  - もし不具合が発生した場合にビジネス上のインパクトが大きい範囲、をカバーする（＝ビジネス上のインパクトが小さい範囲を諦める）
  - 例）人数ベース：IE11を使っているのは3%だから対象外にしよう
  - 例）金額ベース：ガラケーを使っているのは全体の5%だが、売上の30%を占めているから対象にしよう
